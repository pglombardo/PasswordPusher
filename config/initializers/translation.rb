...
I18n.available_locales = %i[ca cs da de en es fi fr hu it lv nl no pl pt-BR pt-PT sr sv zh-CN]
...
TranslationIO.configure do |config|
  ...
  config.target_locales = %i[ca cs da de es fi fr hu it lv nl no pl pt-BR pt-PT sr sv zh-CN]
