...
I18n.available_locales = %i[ca cs da de en es fi fr hu it nl no pl pt-BR sr sv zh-CN]
...
TranslationIO.configure do |config|
  ...
  config.target_locales = %i[ca cs da de es fi fr hu it nl no pl pt-BR sr sv zh-CN]
