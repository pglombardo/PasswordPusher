...
ActiveRecord::Schema[7.0].define(version: 20_230_420_175_410) do
  ...
  create_table 'file_pushes', force: :cascade do |t|
    ...
    t.text 'payload_ciphertext', limit: 16_777_215
    t.text 'text', limit: 16_777_215
  ...
  create_table 'urls', force: :cascade do |t|
    ...
    t.boolean 'retrieval_step', default: false
    t.datetime 'expired_on'
    t.text 'payload_ciphertext', limit: 2_097_152
    t.text 'text', limit: 2_097_152
    t.text 'note_ciphertext'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.text 'passphrase_ciphertext', limit: 2048
