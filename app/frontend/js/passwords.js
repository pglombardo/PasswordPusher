...
function restoreFormValuesFromCookie() {
  ...
  let days_expiration = Cookies.get('pwpush_days') || EXPIRE_AFTER_DAYS_DEFAULT;
  ...
  let views_expiration = Cookies.get('pwpush_views') || EXPIRE_AFTER_VIEWS_DEFAULT;
  ...
  if (deletable_by_viewer) {
    ...
    $('#password_deletable_by_viewer').prop('checked', DELETABLE_PASSWORDS_DEFAULT);
  }
  ...
  if (retrieval_step) {
    ...
    $('#password_retrieval_step').prop('checked', RETRIEVAL_STEP_DEFAULT);
  }
}
