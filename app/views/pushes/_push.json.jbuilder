...
if controller.action_name == "create" && push.notify_emails_to.present?
  json.notify_emails_to push.notify_emails_to
  json.notify_emails_to_locale push.notify_emails_to_locale
end
